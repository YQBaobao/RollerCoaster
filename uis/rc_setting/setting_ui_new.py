...
# Form implementation generated from reading ui file 'setting_ui_new.ui'
#
...
class Ui_Settiing(object):
    def setupUi(self, Settiing):
        ...
        Settiing.resize(589, 289)
        Settiing.setMinimumSize(QtCore.QSize(543, 289))
        icon = QtGui.QIcon()
        ...
        self.scrollArea.setMaximumSize(QtCore.QSize(135, 16777215))
        self.scrollArea.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 135, 224))
        ...
        self.pushButton_other = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.pushButton_other.setCheckable(True)
        self.pushButton_other.setAutoExclusive(True)
        self.pushButton_other.setObjectName("pushButton_other")
        self.buttonGroup.addButton(self.pushButton_other)
        self.gridLayout_3.addWidget(self.pushButton_other, 6, 0, 1, 1)
    ...
    def retranslateUi(self, Settiing):
        ...
        self.pushButton_other.setText(_translate("Settiing", "其他设置"))
