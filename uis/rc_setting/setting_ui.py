...
class Ui_Settiing(object):
    def setupUi(self, Settiing):
        ...
        Settiing.resize(525, 265)
        Settiing.setMinimumSize(QtCore.QSize(525, 265))
        Settiing.setMaximumSize(QtCore.QSize(525, 265))
        icon = QtGui.QIcon()
        ...
        self.stackedWidget.setMinimumSize(QtCore.QSize(365, 0))
        self.stackedWidget.setMaximumSize(QtCore.QSize(365, 16777215))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 136, 200))
        ...
        self.gridLayout_3.addWidget(self.pushButton_monitor, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButton_background_color, 3, 0, 1, 1)
