...
class Ui_BackgroundColor(object):
    def setupUi(self, BackgroundColor):
        ...
        self.gridLayout_7.addWidget(self.pushButton_palette, 0, 0, 1, 1)
        ...
        self.checkBox = QtWidgets.QCheckBox(BackgroundColor)
    ...
    def retranslateUi(self, BackgroundColor):
        ...
        self.pushButton_palette.setText(_translate("BackgroundColor", "使用调色板"))
